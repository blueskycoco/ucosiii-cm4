...
CPU_ARM_REG_SCU_CTRL             EQU  0x00A00000
CPU_ARM_REG_SCU_INV              EQU  0x00A0000C


CPU_ARM_L2C_REG1_CTRL            EQU  0x00A02100
CPU_ARM_L2C_REG1_AUX_CTRL        EQU  0x00A02104
CPU_ARM_L2C_REG1_TAG_RAM_CTRL    EQU  0x00A02108
CPU_ARM_L2C_REG1_DATA_RAM_CTRL   EQU  0x00A0210C

CPU_ARM_L2C_REG7_CACHE_SYNC      EQU  0x00A02730
CPU_ARM_L2C_REG7_CACHE_INV_PA    EQU  0x00A02770
CPU_ARM_L2C_REG7_CACHE_INV_WAY   EQU  0x00A0277C
CPU_ARM_L2C_REG7_CACHE_CLEAN_PA  EQU  0x00A027B0
...
BSP_DCacheInvalidateAll_loop_1
  MOV32   r1, #0x00000003           ; Load number of ways
BSP_DCacheInvalidateAll_loop_2
  ...
  MOV32   r0, #CPU_ARM_L2C_REG7_CACHE_INV_WAY
  MOV32   r1, #0xFFFF
  STR     r1, [r0]
BSP_DCacheInvalidateAll_wait
  ...
  MOV32   r0, CPU_ARM_L2C_REG7_CACHE_SYNC
  MOV     r1, #0
  STR     r1, [r0]
  DSB
  ISB
...
;                                         BSP_L2C310Dis()
;
; Description : Disable L2C310 cache controller.
;
; Prototypes  : void  BSP_L2C310Dis (void)
;
; Argument(s) : none.
;********************************************************************************************************

    EXPORT BSP_L2C310Dis

BSP_L2C310Dis FUNCTION

    MOV32   r0, #CPU_ARM_L2C_REG1_CTRL
    LDR     r1, =0x0                                            ; Disable L2 cache via control register.
    STR     r1, [r0]                                            ; Control register at offset 0x100
