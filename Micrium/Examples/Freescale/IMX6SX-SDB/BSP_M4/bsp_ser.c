...
#define  IMX6_IOMUXC_MUX_PAD_GPIO1_IO06  (*((CPU_REG32 *)(0x420E0000 + 0x374))) /* UART1_TX */
#define  IMX6_IOMUXC_MUX_PAD_GPIO1_IO07  (*((CPU_REG32 *)(0x420E0000 + 0x378))) /* UART1_RX */

#define  IMX6_IOMUXC_MUX_CTL_GPIO1_IO06 (*((CPU_REG32 *)(0x420E0000 + 0x02C))) /* UART2_TX */
#define  IMX6_IOMUXC_MUX_CTL_GPIO1_IO07 (*((CPU_REG32 *)(0x420E0000 + 0x030))) /* UART2_RX */

#define  IMX6_IOMUXC_MUX_CTL_UART2_URDSI (*((CPU_REG32 *)(0x420E0000 + 0x838)))

#define  IMX6_UART_UART2_UCRX (*((CPU_REG32 *)(0x421E8000 + 0x00)))
#define  IMX6_UART_UART2_UCTX (*((CPU_REG32 *)(0x421E8000 + 0x40)))
#define  IMX6_UART_UART2_UCR1 (*((CPU_REG32 *)(0x421E8000 + 0x80)))
#define  IMX6_UART_UART2_UCR2 (*((CPU_REG32 *)(0x421E8000 + 0x84)))
#define  IMX6_UART_UART2_UCR3 (*((CPU_REG32 *)(0x421E8000 + 0x88)))
#define  IMX6_UART_UART2_UBIR (*((CPU_REG32 *)(0x421E8000 + 0xA4)))
#define  IMX6_UART_UART2_UBMR (*((CPU_REG32 *)(0x421E8000 + 0xA8)))
#define  IMX6_UART_UART2_UFCR (*((CPU_REG32 *)(0x421E8000 + 0x90)))
#define  IMX6_UART_UART2_ONEMS (*((CPU_REG32 *)(0x421E8000 + 0xB0)))
#define  IMX6_UART_UART2_UTS (*((CPU_REG32 *)(0x421E8000 + 0xB4)))
...
void  BSP_Ser_WrByte(CPU_INT08U  c)
{
    ...
    while (DEF_BIT_IS_SET(IMX6_UART_UART2_UTS, DEF_BIT_13)) {
        ;
    }

    IMX6_UART_UART2_UCTX = c;
...
{
    while (DEF_BIT_IS_SET(IMX6_UART_UART2_UTS, DEF_BIT_04)) {
        ;
    }
...
CPU_CHAR  BSP_Ser_RdByte (void)
{
    ...
    while (DEF_BIT_IS_SET(IMX6_UART_UART2_UTS, DEF_BIT_05)) {
        ;
    }

    c = IMX6_UART_UART2_UCRX;
