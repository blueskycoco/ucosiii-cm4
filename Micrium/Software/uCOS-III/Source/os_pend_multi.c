...
*
* Note       : 1) This function is INTERNAL to uC/OS-III and your application should not call it.
*
* Note(s)    : 2) This function is DEPRECATED, see OSPendMulti() note 1 for details.
************************************************************************************************************************
*/
